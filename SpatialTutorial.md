Basic data structures in R can represent spatial data. All we need are
some vectors with location and attribute information.
...
![plot of chunk
unnamed-chunk-2](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-2.png)

Packages early on in R came at handling spatial data in their own way -
maps package is great example - database of locational information that
is quite handy.The maps package format was developed in S (R is
implementation of S) - lines represented as a sequence of points
separated by 'NA' values - think of as drawing with a pen, raising at
NA, then lowering at a value. Bad for associating with data since
objects are only distinguished by separation with NA values.

    library(maps)
    map()

![plot of chunk
unnamed-chunk-3](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-31.png)
...
![plot of chunk
unnamed-chunk-3](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-32.png)

The maptools package provides convenience function for making spatial
objects from map objects.
    ...
    ## [19] "oregon,lake"       "oregon,lane"       "oregon,linn"      
    ## [22] "oregon,lincoln"    "oregon,malheur"    "oregon,marion"    
...
![plot of chunk
unnamed-chunk-4](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-4.png)

Spatial classes provided in sp package have mostly standardized spatial
data in R and provide a solid way to represent and work with spatial
data in R.
...
Construct a spatial object in R from a data frame with coordinate
information - we'll use the built-in dataset 'quakes' with information
on earthquakes off the coast of Fiji. After creating spatial object,
promote it to a spatial data frame object.
...
![plot of chunk
unnamed-chunk-6](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-6.png)
...
![plot of chunk
unnamed-chunk-7](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-71.png)
...
![plot of chunk
unnamed-chunk-7](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-72.png)

    levelplot(alt, layers=1, FUN.margin=median, contour=TRUE)

![plot of chunk
unnamed-chunk-7](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-73.png)

    histogram(alt)

![plot of chunk
unnamed-chunk-7](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-74.png)

    densityplot(alt)

![plot of chunk
unnamed-chunk-7](./SpatialTutorial_files/figure-markdown_strict/unnamed-chunk-75.png)
