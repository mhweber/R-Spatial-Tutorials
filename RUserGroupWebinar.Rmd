...
```{r, echo=TRUE, message=FALSE, warning=FALSE, out.width= '200px', fig.align='right'}
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, out.width= '300px', fig.align='center'}
...
```{r, echo=TRUE, warning=FALSE, message=FALSE,out.width= '500px', fig.align='center'}
library(ggmap)
